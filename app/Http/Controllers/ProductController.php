...
class ProductController extends Controller
{
    ...
    public function update(Request $request, Product $product){
        ...
        if($request->has('ifar_info')) {
            if($product->ifar){
                $product->ifar->update(['additional_info' => $request->ifar_info]);
            }
        } 
        if($request->has('trip_delay_label')){
            if($request->id){
        ...
        if($request->has('trip_delay_info')) {
            $trip_delay = $product->trip_delays()->where('id', $request->id)->first();
            $trip_delay->update(['additional_info' => $request->trip_delay_info]);
        } 
        if($request->has('missed_connection')){
        ...
        if($request->has('emergency_medical')){
        ...
        if($request->has('preexisting_condition')){
        ...
        if($request->has('baggage_loss_label')){
            if($request->id){
        ...
        if($request->has('baggage_delay_label')){
            if($request->id){
        ...
        if($request->has('cancellation_for_work_reason')){
        ...
        if($request->has('disaster_evacuation')){
        ...
        if($request->has('car_rental_damage')){
