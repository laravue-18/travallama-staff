      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(Icon, {
              name: "users",
              class: ["mr-2 w-4 h-4", isUrl("quotes") ? "fill-white" : "fill-indigo-400 group-hover:fill-white"]
            }, null, _parent2, _scopeId));
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(Icon, {
              name: "users",
              class: ["mr-2 w-4 h-4", isUrl("/new-quote") ? "fill-white" : "fill-indigo-400 group-hover:fill-white"]
            }, null, _parent2, _scopeId));
            _push2(`<div class="${ssrRenderClass(isUrl("new-quote") ? "text-white" : "text-indigo-300 group-hover:text-white")}"${_scopeId}> New Quote </div>`);
          } else {
            return [
              createVNode(Icon, {
                name: "users",
              ...
              createVNode("div", {
                class: isUrl("new-quote") ? "text-white" : "text-indigo-300 group-hover:text-white"
              }, " New Quote ", 2)
            ];
          }
        }),
