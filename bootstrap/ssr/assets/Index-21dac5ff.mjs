import { _ as _sfc_main$i } from "./AuthenticatedLayout-e5d31bb3.mjs";
...
import { v4 } from "uuid";
import { mergeProps, useSSRContext, getCurrentInstance, nextTick, h, resolveComponent, resolveDirective, withCtx, createTextVNode, toDisplayString, createSlots, createVNode, openBlock, createBlock, Fragment, renderList, renderSlot } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderSlot, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrGetDirectiveProps, ssrRenderTeleport, ssrRenderStyle, ssrRenderComponent, ssrRenderList } from "vue/server-renderer";
...
const _sfc_main = {
  components: {
    AuthenticatedLayout: _sfc_main$i,
    Head,
    Link,
    Pagination,
    Disclosure,
  ...
  _push(ssrRenderComponent(_component_AuthenticatedLayout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<div class="text-right mb-3"${_scopeId}>`);
        ...
        return [
          ...
          createVNode(_component_Collapse, { class: "mb-6" }, {
            default: withCtx(() => [
              createVNode(_component_Panel, null, {
                content: withCtx(() => [
                  createVNode("div", { class: "grid grid-cols-3 lg:grid-cols-7 gap-12" }, [
          ...
          createVNode("div", { class: "text-right mb-3" }, [
