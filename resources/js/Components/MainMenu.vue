...
<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/quotes">
        <icon
          name="users"
          class="mr-2 w-4 h-4"
          :class="isUrl('quotes') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'"
        />
        <div :class="isUrl('quotes') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">
          Quotes
        </div>
      </Link>
    </div>
